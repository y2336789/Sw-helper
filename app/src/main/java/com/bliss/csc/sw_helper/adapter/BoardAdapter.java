...
public class BoardAdapter extends RecyclerView.Adapter<BoardAdapter.GalleryViewHolder> {
    ...
    @NonNull
    @Override
    public BoardAdapter.GalleryViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
