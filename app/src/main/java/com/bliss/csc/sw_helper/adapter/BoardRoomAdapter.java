...
public class BoardRoomAdapter extends RecyclerView.Adapter<BoardRoomAdapter.BoardViewHolder> {
    ...
    public BoardViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        final BoardRoomAdapter.BoardViewHolder boardViewHolder = new BoardRoomAdapter.BoardViewHolder(activity, cardView, mDataset.get(viewType));
            ...
            public boolean onMenuItemClick(MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    case R.id.modify:
                        ...
                        return true;
                    case R.id.delete:
                        firebaseFirestore.collection("room").document(mDataset.get(position).getId())
                                .delete()
